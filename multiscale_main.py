...
from multiscale_engine import train_one_epoch, evaluate
...
def get_args_parser():
    ...
    parser.add_argument('--baseWidth', dest = 'baseWidth', default = 28, type = int)
...
def main(args):
    ...
    from model_1.without_attention.model import Rvosnet
    model = Rvosnet(args).to(device)
