...
class FeatureExtractor(nn.Module):
    ...
    def __init__(self):
        ...
        skip_dims_in = get_skip_dims('resnet34')
...
if __name__ == "__main__":
    ...
    model_in= FeatureExtractor()
    # model_out = RSIS(kernel_size=3,dropout=0,down_num=3,baseWidth=38)
    n_parameters1 = sum(p.numel() for p in model_in.parameters() if p.requires_grad)
    stat(model_in, input_size = (1, 256, 256))
